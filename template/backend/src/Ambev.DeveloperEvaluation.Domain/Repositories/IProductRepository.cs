...
public interface IProductRepository
{
    ...
    Task<(IReadOnlyList<Product> Products, int Total)> GetAllAsync(int page, int size, string? order, CancellationToken ct);
    Task<IReadOnlyList<string>> GetAllCategoriesAsync(CancellationToken ct);
